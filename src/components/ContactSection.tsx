...
const ContactSection = () => {
  return (
    <section id="contact" className="py-20 bg-hotel-blue text-white relative overflow-hidden">
      {/* Decorative elements */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="reveal">
            ...
            <p className="text-lg text-white/80 mb-8">
              ...
              Мы проанализируем текущее состояние вашего бизнеса и предложим 
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80">г. Москва, ул. Гостиничная, 123, офис 45</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="reveal">
            <Card className="border-none shadow-xl bg-white text-black">
              <CardContent className="p-6">
                <h3 className="text-2xl font-bold mb-6 text-hotel-blue">Оставьте заявку</h3>
